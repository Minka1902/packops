...
import { useAppointments, useBusiness, useExpenses, useInvoices, useOrders, useStays } from '@/features/business/hooks/useBusiness';
import { usePermissions } from '@/shared/hooks/usePermissions';
import { appointmentVolumeByDay, orderFunnel, revenueByDay, topProducts, topServices } from '@/shared/lib/reports';
import { expensesByCategory, profitAndLoss } from '@/shared/lib/expenses';
import { occupancyByDate, todayStr } from '@/shared/lib/occupancy';
import { EXPENSE_CATEGORY_LABELS, isModuleEnabled } from '@/shared/types';
